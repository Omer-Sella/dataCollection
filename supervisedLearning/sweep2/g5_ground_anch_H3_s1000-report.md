...
- Binomial NLL: **10.6818** (noise floor 10.1070)
- reward MAE: **0.03273**
...
- Binomial NLL: **9.8295** (noise floor 8.6699)
- reward MAE: **0.06114**
- k MAE: **1.60** logical qubits
- Spearman: **0.719**, Kendall: 0.529
...
- Binomial NLL: **9.9825** (noise floor 7.3791)
- reward MAE: **0.10253**
- k MAE: **2.44** logical qubits
- Spearman: **0.631**, Kendall: 0.454
- top-k overlap (k=50): **0.06**
...
- Binomial NLL: **12.9444** (noise floor 10.4257)
- reward MAE: **0.07663**
- k MAE: **1.80** logical qubits
- Spearman: **0.484**, Kendall: 0.337
