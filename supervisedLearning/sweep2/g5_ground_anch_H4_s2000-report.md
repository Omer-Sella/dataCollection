...
- Binomial NLL: **10.7498** (noise floor 10.0992)
- reward MAE: **0.03556**
...
- Binomial NLL: **10.2428** (noise floor 8.6802)
- reward MAE: **0.07923**
- k MAE: **1.61** logical qubits
- Spearman: **0.655**, Kendall: 0.478
...
- Binomial NLL: **11.0489** (noise floor 7.3877)
- reward MAE: **0.14900**
- k MAE: **2.46** logical qubits
- Spearman: **0.611**, Kendall: 0.440
...
- Binomial NLL: **15.4637** (noise floor 10.4284)
- reward MAE: **0.07765**
- k MAE: **1.82** logical qubits
- Spearman: **0.283**, Kendall: 0.192
