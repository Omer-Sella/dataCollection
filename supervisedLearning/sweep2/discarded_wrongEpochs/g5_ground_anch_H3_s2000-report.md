...
- Binomial NLL: **10.6400** (noise floor 10.0992)
- reward MAE: **0.03161**
- k MAE: **1.30** logical qubits
- Spearman: **0.860**, Kendall: 0.681
...
- Binomial NLL: **10.2010** (noise floor 8.6802)
- reward MAE: **0.08165**
- k MAE: **1.60** logical qubits
- Spearman: **0.710**, Kendall: 0.520
...
- Binomial NLL: **11.0880** (noise floor 7.3877)
- reward MAE: **0.14552**
- k MAE: **2.44** logical qubits
- Spearman: **0.589**, Kendall: 0.417
...
- Binomial NLL: **14.5978** (noise floor 10.4284)
- reward MAE: **0.12440**
- k MAE: **1.82** logical qubits
- Spearman: **0.488**, Kendall: 0.341
