...
- Binomial NLL: **10.6479** (noise floor 10.0992)
- reward MAE: **0.03181**
...
- Binomial NLL: **10.0414** (noise floor 8.6802)
- reward MAE: **0.07026**
- k MAE: **1.59** logical qubits
- Spearman: **0.704**, Kendall: 0.514
...
- Binomial NLL: **10.1082** (noise floor 7.3877)
- reward MAE: **0.11621**
...
- Binomial NLL: **12.5688** (noise floor 10.4284)
- reward MAE: **0.06514**
- k MAE: **1.81** logical qubits
- Spearman: **0.510**, Kendall: 0.357
