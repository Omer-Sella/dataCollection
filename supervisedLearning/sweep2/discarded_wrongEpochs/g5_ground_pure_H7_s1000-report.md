...
- Binomial NLL: **10.9692** (noise floor 10.1070)
- reward MAE: **0.04094**
...
- Binomial NLL: **9.9629** (noise floor 8.6699)
- reward MAE: **0.06141**
...
- Binomial NLL: **10.1472** (noise floor 7.3791)
- reward MAE: **0.10645**
- k MAE: **2.37** logical qubits
- Spearman: **0.594**, Kendall: 0.426
...
- Binomial NLL: **14.5502** (noise floor 10.4257)
- reward MAE: **0.11962**
- k MAE: **1.81** logical qubits
- Spearman: **0.524**, Kendall: 0.368
- top-k overlap (k=50): **0.16**
