...
- Binomial NLL: **10.6666** (noise floor 10.1295)
- reward MAE: **0.03193**
...
- Binomial NLL: **9.7962** (noise floor 8.6775)
- reward MAE: **0.05655**
- k MAE: **1.62** logical qubits
- Spearman: **0.696**, Kendall: 0.508
...
- Binomial NLL: **9.8975** (noise floor 7.3856)
- reward MAE: **0.10742**
- k MAE: **2.45** logical qubits
- Spearman: **0.608**, Kendall: 0.433
...
- Binomial NLL: **13.0900** (noise floor 10.4230)
- reward MAE: **0.06588**
- k MAE: **1.83** logical qubits
- Spearman: **0.505**, Kendall: 0.355
