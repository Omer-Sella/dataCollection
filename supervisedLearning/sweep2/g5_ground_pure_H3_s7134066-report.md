...
- Binomial NLL: **10.7975** (noise floor 10.1295)
- reward MAE: **0.03386**
...
- Binomial NLL: **10.7339** (noise floor 8.6775)
- reward MAE: **0.10100**
- k MAE: **1.57** logical qubits
- Spearman: **0.719**, Kendall: 0.528
...
- Binomial NLL: **11.7758** (noise floor 7.3856)
- reward MAE: **0.14963**
- k MAE: **2.42** logical qubits
- Spearman: **0.678**, Kendall: 0.492
- top-k overlap (k=50): **0.20**
...
- Binomial NLL: **15.9109** (noise floor 10.4230)
- reward MAE: **0.13063**
