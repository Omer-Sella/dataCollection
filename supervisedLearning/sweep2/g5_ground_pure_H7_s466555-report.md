...
- Binomial NLL: **10.5998** (noise floor 10.1008)
- reward MAE: **0.02979**
- k MAE: **0.80** logical qubits
- Spearman: **0.879**, Kendall: 0.702
...
- Binomial NLL: **10.6414** (noise floor 8.6757)
- reward MAE: **0.09241**
...
- Binomial NLL: **10.8526** (noise floor 7.3754)
- reward MAE: **0.12241**
- k MAE: **2.45** logical qubits
- Spearman: **0.578**, Kendall: 0.411
...
- Binomial NLL: **13.9423** (noise floor 10.4262)
- reward MAE: **0.08023**
- k MAE: **1.81** logical qubits
- Spearman: **0.369**, Kendall: 0.251
