...
- Binomial NLL: **10.6356** (noise floor 10.0992)
- reward MAE: **0.03158**
...
- Binomial NLL: **10.2080** (noise floor 8.6802)
- reward MAE: **0.07450**
- k MAE: **1.60** logical qubits
- Spearman: **0.685**, Kendall: 0.501
...
- Binomial NLL: **10.9229** (noise floor 7.3877)
- reward MAE: **0.13147**
- k MAE: **2.45** logical qubits
- Spearman: **0.707**, Kendall: 0.524
- top-k overlap (k=50): **0.02**
...
- Binomial NLL: **14.3501** (noise floor 10.4284)
- reward MAE: **0.12116**
- k MAE: **1.82** logical qubits
- Spearman: **0.474**, Kendall: 0.334
