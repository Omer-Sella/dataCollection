...
- Binomial NLL: **10.6743** (noise floor 10.1295)
- reward MAE: **0.03175**
...
- Binomial NLL: **9.9471** (noise floor 8.6775)
- reward MAE: **0.06673**
- k MAE: **1.59** logical qubits
- Spearman: **0.693**, Kendall: 0.505
...
- Binomial NLL: **10.1853** (noise floor 7.3856)
- reward MAE: **0.10710**
- k MAE: **2.42** logical qubits
- Spearman: **0.639**, Kendall: 0.461
- top-k overlap (k=50): **0.06**
...
- Binomial NLL: **13.8250** (noise floor 10.4230)
- reward MAE: **0.09017**
