...
- Binomial NLL: **10.7415** (noise floor 10.1008)
- reward MAE: **0.03392**
...
- Binomial NLL: **9.9306** (noise floor 8.6757)
- reward MAE: **0.06903**
- k MAE: **1.64** logical qubits
- Spearman: **0.736**, Kendall: 0.544
...
- Binomial NLL: **9.8274** (noise floor 7.3754)
- reward MAE: **0.09742**
- k MAE: **2.49** logical qubits
- Spearman: **0.650**, Kendall: 0.469
...
- Binomial NLL: **12.8572** (noise floor 10.4262)
- reward MAE: **0.07991**
