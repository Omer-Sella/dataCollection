...
- Binomial NLL: **10.9542** (noise floor 10.1008)
- reward MAE: **0.04102**
...
- Binomial NLL: **10.6547** (noise floor 8.6757)
- reward MAE: **0.09074**
- k MAE: **1.61** logical qubits
- Spearman: **0.659**, Kendall: 0.476
- top-k overlap (k=50): **0.14**
...
- Binomial NLL: **11.7569** (noise floor 7.3754)
- reward MAE: **0.15914**
- k MAE: **2.45** logical qubits
- Spearman: **0.639**, Kendall: 0.459
...
- Binomial NLL: **14.0805** (noise floor 10.4262)
- reward MAE: **0.10094**
- k MAE: **1.82** logical qubits
- Spearman: **0.543**, Kendall: 0.383
